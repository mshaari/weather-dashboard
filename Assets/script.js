...
var latFromCityName; //declare these two variables as universal so they can be accessed/changed throughout
var lonFromCityName;
...
$('#searchCityButton').on('click', function () {    
    ...
    method: 'GET',
        ...
        latFromCityName = response.lat;
        lonFromCityName = response.lon;
    });
});

$('#searchLatLonButton').on('click', function () {    
